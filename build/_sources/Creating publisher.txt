...
=========================================
We will first be creating a workspace to work from, then we will write a simple publisher that will make our virtual Husky drive around randomly. This tutorial is intended for Ubuntu 14.04 and `ROS Indigo <http://wiki.ros.org/indigo>`_.
